...
class Bot(RoomObject):
    def __init__(self, room, x, y, bot_colour, other_team_bot, my_team_bot):
        ...
        if bot_colour == Globals.BLUE_COLOUR:
            ...
            self.JAIL_POSITION = (
                Globals.GAME_AREA_WIDTH_MIN + JAIL_PADDING,
                Globals.GAME_AREA_HEIGHT_MIN + JAIL_PADDING,
            )
            ...
            self.JAIL_POSITION = (
                Globals.GAME_AREA_WIDTH_MAX - JAIL_PADDING - BOT_SIZE,
                Globals.GAME_AREA_HEIGHT_MAX - JAIL_PADDING - BOT_SIZE,
            )
        ...
        self.set_image(bot_image, 35, 35)
    ...
    def distance_to_flag_blue(self):
        return self.point_to_point_distance(self.x, self.y, Globals.blue_flag.x, Globals.blue_flag.y)

    def distance_to_flag_red(self):
        return self.point_to_point_distance(self.x, self.y, Globals.red_flag.x, Globals.red_flag.y)
