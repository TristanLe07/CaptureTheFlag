...
class Globals:
    ...
    red_team_logo = os.path.join("teamLogos", "red_team.jpg")
    blue_team_logo = os.path.join("teamLogos", "blue_team.jpg")
    ...
    GAME_AREA_BORDER = (GAME_AREA_WIDTH_MAX - GAME_AREA_WIDTH_MIN) / 2 + GAME_AREA_WIDTH_MIN
